...
interface UploadPreviewMinimapProps {
  /**
   * The object URL of the image to display.
   */
  previewUrl: string;
  /**
 ...
 *
 * @param {UploadPreviewMinimapProps} props The component props.
 * @returns A React component representing the minimap, or null if dimensions are not available.
 */
export const UploadPreviewMinimap = ({
  previewUrl,
  rotation,
  alt,
  transformState,
  viewingBox,
}: UploadPreviewMinimapProps) => {
  ...
  return (
    ...
    <div
      ...
      aria-hidden="true"
    >
      {/* The background image is a scaled-down version of the main preview, rotated to match. */}
      <Image
        key={previewUrl}
        src={previewUrl}
        alt={alt}
...
UploadPreviewMinimap.displayName = "UploadPreviewMinimap";
