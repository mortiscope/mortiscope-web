...
interface PdfExportPermissionsStepProps {
  ...
  /** The current value of the owner password. */
  password: string;
 ...
 * allows the user to configure detailed restrictions for the PDF and set an owner password
 * to protect these settings. It is a fully controlled component.
 */
  ...
  return (
    ...
    <div className={cn("space-y-6", isPending && "pointer-events-none opacity-50")}>
      ...
      <div className="space-y-3">
        ...
        {/* A scrollable container for the list of permissions. */}
        <div className="scrollbar-thin scrollbar-track-transparent scrollbar-thumb-transparent hover:scrollbar-thumb-slate-300 max-h-62 space-y-3.25 overflow-y-auto rounded-2xl border-2 border-slate-200 p-4">
      ...
      <div className="space-y-3">
        <Label className="font-inter text-sm font-normal text-slate-700">
          Set a password to protect these permission settings.
        </Label>
        <PdfPasswordInput
          value={password}
