          ...
          <div className="space-y-4">
            <div>
              <ul className="space-y-4">
                <DashboardInformationItem icon={PiRecycle} title="Life Stage Distribution">
                ...
                <DashboardInformationItem icon={IoHourglassOutline} title="PMI Distribution">
                  <ul className="space-y-1 marker:text-emerald-500">
                    <li className="ml-6 list-disc pl-2">
                ...
                <DashboardInformationItem icon={PiCirclesThree} title="Sampling Density">
                  <ul className="space-y-1 marker:text-emerald-500">
                    <li className="ml-6 list-disc pl-2">
