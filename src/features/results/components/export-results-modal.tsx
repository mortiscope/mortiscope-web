                ...
                <ul className="mt-3 mb-4 space-y-1 text-slate-600">
                  ...
                  <li className="flex items-start">
                    ...
                    <p>
                      ...
                      &nbsp; Allows the data to be used with other software or for academic
                      research.
                    </p>
                  </li>
                </ul>
                <p>
                  The generated archive will contain all original images and a detailed JSON file
                  with the complete analysis results.
                </p>
              </div>
            </DialogDescription>
          </motion.div>
