    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "size-(--cell-size) p-0 select-none cursor-pointer",
        ...
        range_middle: cn("bg-emerald-100 rounded-none", defaultClassNames.range_middle),
        range_end: cn("rounded-r-md bg-accent", defaultClassNames.range_end),
        today: cn(
          "bg-emerald-100 text-emerald-900 rounded-md data-[selected=true]:rounded-none",
